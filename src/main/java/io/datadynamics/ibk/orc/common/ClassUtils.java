...
public class ClassUtils {
    ...
    /**
     * Determines the most specific method that can be invoked for the given {@code method}
     * on the specified {@code targetClass}. This is particularly useful when dealing with
     * methods that may be overridden in subclasses or are bridged in their implementation.
     *
     * @param method      the method to introspect, typically obtained from the declaring class
     * @param targetClass the target class for the method invocation, potentially a subclass of the declaring class
     * @return the most specific method on the target class if found, otherwise the input {@code method} itself
     */
